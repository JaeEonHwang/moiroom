...
//        // 바인딩된 레이아웃의 최상위 뷰를 현재 액티비티의 뷰로 설정
        ...
        // 클라이언트 아이디 추가 필요
        val url = "https://api.instagram.com/oauth/authorize?client_id=&redirect_uri=https://example.com/instagramredirection&scope=user_profile,user_media&response_type=code"
        webView.loadUrl(url)
    }
